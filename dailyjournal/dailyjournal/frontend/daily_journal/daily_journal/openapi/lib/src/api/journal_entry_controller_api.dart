...
import 'package:openapi/src/model/journal_entry.dart';
...
class JournalEntryControllerApi {
  ...
  Future<Response<void>> deleteJournalEntry({ 
    ...
    final _path = r'/api/journal/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
