...
public class ChildAsserts {
    ...
    public static void assertChildUpdatableRelationshipsEquals(Child expected, Child actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getGeoFence()).as("check geoFence").isEqualTo(actual.getGeoFence()))
            .satisfies(e -> assertThat(e.getBatteryStatus()).as("check batteryStatus").isEqualTo(actual.getBatteryStatus()))
