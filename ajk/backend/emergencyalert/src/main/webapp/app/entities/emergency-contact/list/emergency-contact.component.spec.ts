...
import { sampleWithRequiredData } from '../emergency-contact.test-samples';
...
describe('EmergencyContact Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.emergencyContacts()[0]).toEqual(expect.objectContaining({ id: 32648 }));
  });

  describe('trackId', () => {
    it('Should forward to emergencyContactService', () => {
      const entity = { id: 32648 };
      jest.spyOn(service, 'getEmergencyContactIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEmergencyContactIdentifier).toHaveBeenCalledWith(entity);
