...
import emergencyContactResolve from './emergency-contact-routing-resolve.service';

describe('EmergencyContact routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: EmergencyContactService;
  let resultEmergencyContact: IEmergencyContact | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IEmergencyContact returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        emergencyContactResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultEmergencyContact).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEmergencyContact>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
