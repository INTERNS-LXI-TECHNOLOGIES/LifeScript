...
import { sampleWithRequiredData } from '../geo-fence.test-samples';
...
describe('GeoFence Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.geoFences()[0]).toEqual(expect.objectContaining({ id: 14261 }));
  });

  describe('trackId', () => {
    it('Should forward to geoFenceService', () => {
      const entity = { id: 14261 };
      jest.spyOn(service, 'getGeoFenceIdentifier');
      const id = comp.trackId(entity);
      expect(service.getGeoFenceIdentifier).toHaveBeenCalledWith(entity);
