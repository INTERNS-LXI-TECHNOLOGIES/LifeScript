...
import { sampleWithRequiredData } from '../battery-status.test-samples';
...
describe('BatteryStatus Management Component', () => {
  let comp: BatteryStatusComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(BatteryStatusComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.batteryStatuses()[0]).toEqual(expect.objectContaining({ id: 20924 }));
  });

  describe('trackId', () => {
    it('Should forward to batteryStatusService', () => {
      const entity = { id: 20924 };
      jest.spyOn(service, 'getBatteryStatusIdentifier');
      const id = comp.trackId(entity);
      expect(service.getBatteryStatusIdentifier).toHaveBeenCalledWith(entity);
