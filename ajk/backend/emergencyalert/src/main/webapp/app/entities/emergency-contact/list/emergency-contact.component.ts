...
import { EmergencyContactService, EntityArrayResponseType } from '../service/emergency-contact.service';
...
export class EmergencyContactComponent implements OnInit {
  ...
  protected readonly emergencyContactService = inject(EmergencyContactService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: IEmergencyContact): number => this.emergencyContactService.getEmergencyContactIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.emergencyContacts.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IEmergencyContact[] | null): IEmergencyContact[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.emergencyContactService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
