...
import { ChildService, EntityArrayResponseType } from '../service/child.service';
...
export class ChildComponent implements OnInit {
  ...
  protected readonly childService = inject(ChildService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: IChild): number => this.childService.getChildIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.children.set(dataFromBody);
  }
