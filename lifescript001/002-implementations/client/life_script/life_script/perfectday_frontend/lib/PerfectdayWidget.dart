...
import 'package:perfectday_frontend/ViewDayPlansPage.dart';
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                ...
                // Second Button for Another Page
                ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ViewDayPlansPage(), // Replace with your page
                      ),
                    );
                  },
                  style: ElevatedButton.styleFrom(
