...
import 'package:goal_setting_openapi/openapi.dart';
                ...
                children: [
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                focusedErrorBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                    color: Color.fromARGB(0, 223, 220, 220),
                                    width: 1.0,
                                  ),
                                  borderRadius: BorderRadius.circular(8.0),
                                ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText:
                                    'Add your thoughts and progress notes...',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Inter',
                  ...
                  FFButtonWidget(
                    onPressed: () {
                      ...
                      final title1 = _model.textController1.text;
                      final description1 = _model.textController2.text;
                      final isCompleted1 = _model.textController1.text;
                      bool? bool1 = parseBoolean(isCompleted1);

                      GoalControllerApi goalControllerApi =
                          Openapi().getGoalControllerApi();

                      final goal1 = Goal((b) => b
                        ..title = title1
