...
import 'package:goal_setting_openapi/src/serializers.dart';
import 'package:goal_setting_openapi/src/auth/api_key_auth.dart';
import 'package:goal_setting_openapi/src/auth/basic_auth.dart';
import 'package:goal_setting_openapi/src/auth/bearer_auth.dart';
import 'package:goal_setting_openapi/src/auth/oauth.dart';
import 'package:goal_setting_openapi/src/api/account_resource_api.dart';
import 'package:goal_setting_openapi/src/api/authenticate_controller_api.dart';
import 'package:goal_setting_openapi/src/api/authority_resource_api.dart';
import 'package:goal_setting_openapi/src/api/goal_resource_api.dart';
import 'package:goal_setting_openapi/src/api/public_user_resource_api.dart';
import 'package:goal_setting_openapi/src/api/user_resource_api.dart';
...
class Openapi {
  ...
  /// Get GoalResourceApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  GoalResourceApi getGoalResourceApi() {
    return GoalResourceApi(dio, serializers);
  }
