...
class _$Goal extends Goal {
  ...
  _$Goal._({this.id, required this.title, this.description, this.isCompleted})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(title, r'Goal', 'title');
  }
...
class GoalBuilder implements Builder<Goal, GoalBuilder> {
  ...
  _$Goal _build() {
    final _$result = _$v ??
        new _$Goal._(
          id: id,
          title: BuiltValueNullFieldError.checkNotNull(title, r'Goal', 'title'),
