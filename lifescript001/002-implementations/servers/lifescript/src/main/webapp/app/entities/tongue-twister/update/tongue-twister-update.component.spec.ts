...
describe('TongueTwister Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, TongueTwisterUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      const tongueTwister: ITongueTwister = { id: 456 };
      const creator: IUser = { id: 29467 };
      tongueTwister.creator = creator;

      const userCollection: IUser[] = [{ id: 14468 }];
