...
export class TongueTwisterComponent implements OnInit {
  ...
  trackId = (_index: number, item: ITongueTwister): number => this.tongueTwisterService.getTongueTwisterIdentifier(item);
  ...
  ngOnInit(): void {
    this.subscription = combineLatest([this.activatedRoute.queryParamMap, this.activatedRoute.data])
      .pipe(
        ...
        tap(() => {
          if (!this.tongueTwisters || this.tongueTwisters.length === 0) {
            this.load();
          }
        }),
      )
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.tongueTwisters = this.refineData(dataFromBody);
  }
