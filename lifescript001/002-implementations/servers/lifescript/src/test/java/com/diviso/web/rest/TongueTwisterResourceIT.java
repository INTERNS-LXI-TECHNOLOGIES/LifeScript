...
class TongueTwisterResourceIT {
     ...
     */
    public static TongueTwister createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static TongueTwister createUpdatedEntity(EntityManager em) {
        TongueTwister tongueTwister = new TongueTwister()
            .text(UPDATED_TEXT)
