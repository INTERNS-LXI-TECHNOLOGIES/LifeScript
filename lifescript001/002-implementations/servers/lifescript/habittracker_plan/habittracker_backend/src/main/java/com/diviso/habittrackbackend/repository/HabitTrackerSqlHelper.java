...
public class HabitTrackerSqlHelper {

    public static List<Expression> getColumns(Table table, String columnPrefix) {
        List<Expression> columns = new ArrayList<>();
        columns.add(Column.aliased("id", table, columnPrefix + "_id"));
        columns.add(Column.aliased("habit_id", table, columnPrefix + "_habit_id"));
        columns.add(Column.aliased("habit_name", table, columnPrefix + "_habit_name"));
