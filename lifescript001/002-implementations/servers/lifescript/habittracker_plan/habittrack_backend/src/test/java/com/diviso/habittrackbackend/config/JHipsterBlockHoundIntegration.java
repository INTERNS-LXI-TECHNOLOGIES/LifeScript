package com.diviso.habittrackbackend.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.diviso.habittrackbackend.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.diviso.habittrackbackend.security.DomainUserDetailsService", "createSpringSecurityUser");
