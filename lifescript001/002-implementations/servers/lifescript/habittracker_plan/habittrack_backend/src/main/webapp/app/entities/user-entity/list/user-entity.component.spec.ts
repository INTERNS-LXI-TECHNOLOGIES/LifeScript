...
import { sampleWithRequiredData } from '../user-entity.test-samples';
...
describe('UserEntity Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.userEntities()[0]).toEqual(expect.objectContaining({ id: 27146 }));
  });

  describe('trackId', () => {
    it('Should forward to userEntityService', () => {
      const entity = { id: 27146 };
