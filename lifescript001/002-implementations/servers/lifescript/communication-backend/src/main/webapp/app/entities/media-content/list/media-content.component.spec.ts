...
import { sampleWithRequiredData } from '../media-content.test-samples';
...
describe('MediaContent Management Component', () => {
  let comp: MediaContentComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MediaContentComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.mediaContents()[0]).toEqual(expect.objectContaining({ id: 31411 }));
  });

  describe('trackId', () => {
    it('Should forward to mediaContentService', () => {
      const entity = { id: 31411 };
      jest.spyOn(service, 'getMediaContentIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMediaContentIdentifier).toHaveBeenCalledWith(entity);
