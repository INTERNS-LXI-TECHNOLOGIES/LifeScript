...
import static com.diviso.domain.UserProfileAsserts.*;
...
import com.diviso.domain.UserProfile;
import com.diviso.repository.UserProfileRepository;
...
class UserProfileResourceIT {
    ...
    public static UserProfile createEntity() {
        return new UserProfile().nickName(DEFAULT_NICK_NAME).address(DEFAULT_ADDRESS);
    }
    ...
    public static UserProfile createUpdatedEntity() {
        return new UserProfile().nickName(UPDATED_NICK_NAME).address(UPDATED_ADDRESS);
    }
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.nickName(UPDATED_NICK_NAME).address(UPDATED_ADDRESS);
    ...
    void fullUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.nickName(UPDATED_NICK_NAME).address(UPDATED_ADDRESS);
