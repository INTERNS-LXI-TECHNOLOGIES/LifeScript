...
public class HabitTrackerTestSamples {
    ...
    public static HabitTracker getHabitTrackerSample1() {
        return new HabitTracker().id(1L).habitId(1).habitName("habitName1").description("description1").startDate(1).endDate("endDate1");
    }

    public static HabitTracker getHabitTrackerSample2() {
        return new HabitTracker().id(2L).habitId(2).habitName("habitName2").description("description2").startDate(2).endDate("endDate2");
    }
    ...
    public static HabitTracker getHabitTrackerRandomSampleGenerator() {
        return new HabitTracker()
            ...
            .startDate(intCount.incrementAndGet())
